  ...
  return (
    <div className="bg-orange-800 h-full flex flex-col">
      ...
      <div className="flex-1 overflow-hidden">
        <div className="flex text-xs text-orange-400 px-4 py-2 border-b border-orange-700">
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <div className="space-y-1">
            {sellOrders.reverse().map((order, index) => (
              <div 
                key={`sell-${index}`}
                className="flex items-center px-4 py-1 hover:bg-orange-700/50 transition-colors text-sm"
              >
          ...
          {/* Current price */}
          <div className="px-4 py-3 border-y border-orange-600 bg-orange-700/50">
            <div className="text-center">
              <div className="text-lg font-bold text-green-500">$43,521.45</div>
              <div className="text-xs text-orange-400">Текущая цена</div>
            </div>
          </div>
      ...
      <div className="p-4 border-t border-orange-700">
        <div className="grid grid-cols-2 gap-4 text-sm">
          <div>
            <span className="text-orange-400">Спред:</span>
            <span className="text-white ml-2">$2.67</span>
          </div>
          <div>
            <span className="text-orange-400">Глубина:</span>
